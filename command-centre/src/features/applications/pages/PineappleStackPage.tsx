...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["pineapple-stack"];
  ...
  const entitiesQuery = useApplicationEntities("pineapple-stack", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("pineapple-stack");
  const imagesQuery = useApplicationImages("pineapple-stack");
  const reviewsQuery = useApplicationReviews("pineapple-stack");
