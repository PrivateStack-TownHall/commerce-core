...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["m-ployee"];
  ...
  const entitiesQuery = useApplicationEntities("m-ployee", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("m-ployee");
  const imagesQuery = useApplicationImages("m-ployee");
  const reviewsQuery = useApplicationReviews("m-ployee");
