...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["trade-hub"];
  ...
  const entitiesQuery = useApplicationEntities("trade-hub", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("trade-hub");
  const imagesQuery = useApplicationImages("trade-hub");
  const reviewsQuery = useApplicationReviews("trade-hub");
