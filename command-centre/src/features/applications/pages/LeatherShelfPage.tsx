...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["leather-shelf"];
  ...
  const entitiesQuery = useApplicationEntities("leather-shelf", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("leather-shelf");
  const imagesQuery = useApplicationImages("leather-shelf");
  const reviewsQuery = useApplicationReviews("leather-shelf");
