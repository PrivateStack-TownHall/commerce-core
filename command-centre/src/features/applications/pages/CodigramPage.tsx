...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["codigram"];
  ...
  const entitiesQuery = useApplicationEntities("codigram", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("codigram");
  const imagesQuery = useApplicationImages("codigram");
  const reviewsQuery = useApplicationReviews("codigram");
