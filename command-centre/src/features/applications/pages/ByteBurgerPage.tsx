...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["byte-burger"];
  ...
  const entitiesQuery = useApplicationEntities("byte-burger", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("byte-burger");
  const imagesQuery = useApplicationImages("byte-burger");
  const reviewsQuery = useApplicationReviews("byte-burger");
