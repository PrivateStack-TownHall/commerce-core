...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["castle-kitchen"];
  ...
  const entitiesQuery = useApplicationEntities("castle-kitchen", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("castle-kitchen");
  const imagesQuery = useApplicationImages("castle-kitchen");
  const reviewsQuery = useApplicationReviews("castle-kitchen");
