...
function KingsBrewPage() {
  const config = APPLICATION_CONFIG["quantum-mart"];
  ...
  const entitiesQuery = useApplicationEntities("quantum-mart", {
    search,
    categoryId,
    sort,
    order,
  ...
  const categoriesQuery = useApplicationCategories("quantum-mart");
  const imagesQuery = useApplicationImages("quantum-mart");
  const reviewsQuery = useApplicationReviews("quantum-mart");
